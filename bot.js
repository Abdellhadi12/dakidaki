...
client.on("guildMemberAdd", member => { 
        if(member.guild.id === "509664713617965087") { 
setTimeout(function(){ 
  const channel = member.guild.channels.find('id', '509665635270393857');  
if (!channel) return; 
...
antispam(client, {
  warnBuffer: 5, //الحد الأقصى المسموح به من الرسائل لإرسالها في الفاصل الزمني قبل الحصول على تحذير.
  ...
  warningMessage: "stop or mute MTF.", // رسالة تحذير اذا سوا سبام!
  roleMessage: "STUF!!", // الرسالة الي تجي اذا شخص اخذ ميوت
  roleName: "Muted", // اسم رتبة الميوت
  maxDuplicatesWarning: 7, // عدد الرسايل الي قبل التحذيرات
  maxDuplicatesBan: 8, // عدد الرسايل الي يقدر المستخدم يرسلها قبل الميوت
